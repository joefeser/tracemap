...
test("validateDist accepts generated public sitemap and internal links", async () => {
  ...
  await validateDist({ requireAccessRebuildReadiness: false, requireGraphHistoryBugs: false, requireCsharpExtractionTruth: false, requireAccessSafeEvidenceAcquisition: false, requireMsbuildBinlogEvidence: false, root });
});
...
test("validateDist normalizes trailing slash baseUrl values", async () => {
  ...
  await validateDist({ baseUrl: "https://tracemap.tools/", requireAccessRebuildReadiness: false, requireGraphHistoryBugs: false, requireCsharpExtractionTruth: false, requireAccessSafeEvidenceAcquisition: false, requireMsbuildBinlogEvidence: false, root });
});
