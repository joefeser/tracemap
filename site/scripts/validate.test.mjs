...
test("validateDist reports missing dist directory through validation errors", async () => {
  ...
  await assert.rejects(
    validateDist({ requireStaticEventFlowArticle: false, root }),
...
test("validateDist rejects generated HTML without top navigation", async () => {
  ...
  await assert.rejects(validateDist({ requireStaticEventFlowArticle: false, root }), /docs\/index\.html is missing <nav class="top-nav">/);
});
