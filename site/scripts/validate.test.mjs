...
test("validateDist accepts generated public sitemap and internal links", async () => {
  ...
  await validateDist({ requireReverseImpactDispatchStories: false, requireAccessRebuildReadiness: false, requireGraphHistoryBugs: false, requireCsharpExtractionTruth: false, requireAccessSafeEvidenceAcquisition: false, requireMsbuildBinlogEvidence: false, root });
});
...
test("validateDist normalizes trailing slash baseUrl values", async () => {
  ...
  await validateDist({ baseUrl: "https://tracemap.tools/", requireReverseImpactDispatchStories: false, requireAccessRebuildReadiness: false, requireGraphHistoryBugs: false, requireCsharpExtractionTruth: false, requireAccessSafeEvidenceAcquisition: false, requireMsbuildBinlogEvidence: false, root });
});
