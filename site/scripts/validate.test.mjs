...
test("validateDist accepts generated public sitemap and internal links", async () => {
  ...
  await validateDist({ requireGraphHistoryBugs: false, requireCsharpExtractionTruth: false, requireAccessSafeEvidenceAcquisition: false, requireMsbuildBinlogEvidence: false, root });
});
...
test("validateDist normalizes trailing slash baseUrl values", async () => {
  ...
  await validateDist({ baseUrl: "https://tracemap.tools/", requireGraphHistoryBugs: false, requireCsharpExtractionTruth: false, requireAccessSafeEvidenceAcquisition: false, requireMsbuildBinlogEvidence: false, root });
});
