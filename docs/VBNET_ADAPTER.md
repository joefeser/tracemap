...
| Shared Web Forms extractor | `legacy-webforms/0.8.6` | Tier1/Tier2/Tier3 facts and Tier4 gaps | existing `legacy.webforms.*` contracts, now with bounded VB code-behind/designer parsing and shared database/WCF/ASMX terminal projection |
