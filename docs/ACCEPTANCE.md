...
- HTTP and database operation facts are traversed only when explicitly requested and only when semantic evidence supplies canonical source and target endpoints.
