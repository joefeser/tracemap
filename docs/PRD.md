...
- The scanner emits queryable call edges, object creation facts, argument-flow facts, local-alias facts, field-alias facts, parameter-forwarding edges, assembly identity, and review-routing logic shape facts.
