...
- The scanner emits queryable call edges, object creation facts, argument-flow facts, local-alias facts, field-alias facts, parameter-forwarding edges, exact symbol identity tables, flow-boundary facts, runtime-evidence facts, assembly identity, and review-routing logic shape facts.
