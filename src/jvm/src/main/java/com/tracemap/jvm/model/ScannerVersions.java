...
public final class ScannerVersions {
    private ScannerVersions() {
    }

    public static final String TRACEMAP_JVM = "tracemap-jvm-mvp";
    ...
    public static final String KOTLIN_SYNTAX = "jvm-kotlin-syntax/0.1.0";
    public static final String INTEGRATION = "jvm-integration/0.1.0";
}
