...
public static class FlowPathReporter
{
        ...
        int maxPaths)
    {
        ...
        builder.AppendLine();
        builder.AppendLine("This report follows direct parameter-to-parameter forwarding evidence only. It does not infer runtime execution, field aliases, mutations, dependency injection, reflection, dynamic dispatch, or serializer-created values.");
        builder.AppendLine();
