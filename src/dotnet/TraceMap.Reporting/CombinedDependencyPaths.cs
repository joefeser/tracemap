...
public static partial class CombinedDependencyPathReporter
{
        ...
        IReadOnlyList<CombinedFactRow> facts)
    {
        ...
        foreach (var call in syntaxCalls)
        {
            ...
            var memberReceiverCreations = creations
            ...
            var receiverCreations = memberReceiverCreations.Length > 0
                ...
                : creations
                    .Where(creation => IsMatchingVisualBasicReceiverFieldCreation(creation, call, receiverName, fieldDeclarations))
                    .OrderBy(creation => creation.StartLine)
                    .ThenBy(creation => creation.CombinedFactId, StringComparer.Ordinal)
                    .ToArray();
    ...
    private static GraphNode ToSurfaceNode(CombinedDependencySurfaceRow surface)
    {
        return new GraphNode(
            ...
            Limitations: surface.SurfaceKind == "legacy-data" ? surface.LegacyDataLimitations : null);
    }
