...
internal static class AccessDesignReviewComposer
{
    ...
    private static ReleaseReviewFinding? FromFact(AccessDesignFactRow row)
    {
        ...
        var (kind, metadata, classification) = fact.FactType switch
        {
            ...
            FactTypes.AccessControlDeclared => ("control", DesignMetadata(fact.Properties, "controlType", "ordinal", "valueBindingClassification", "populationSourceType", "populationTargetStableKeys", "populationCoverage", "boundColumn", "selectedProjectionOrdinals", "selectedValueStableKeys", "persistenceTargetStableKeys", "functionalRole", "coverageLabel"), ReleaseReviewClassifications.NoActionableEvidence),
            FactTypes.AccessBindingDeclared => ("binding", DesignMetadata(fact.Properties, "bindingKind", "sourceKind", "targetKind", "expressionClassification", "expressionCoverage", "expressionFieldStableKeys", "expressionControlReferenceHashes", "expressionQueryStableKeys", "expressionSelectedFieldStableKeys", "expressionCriteriaFieldStableKeys", "coverageLabel"), DesignClassification(fact.Properties)),
