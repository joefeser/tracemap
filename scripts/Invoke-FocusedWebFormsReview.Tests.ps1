...
Assert-True ($content.Contains('FOLDER_SCOPE_UNAVAILABLE;requested=$folder;sourceRoot=$SourceRoot', [StringComparison]::Ordinal)) "missing folder paths must identify the requested value and source root"
