# Access Parallels Source Runner Tasks

- [x] Verify `prlctl exec` can invoke the isolated Windows guest.
- [x] Establish a guest-local offline source clone and toolchain.
- [x] Build the full .NET solution and run Access-focused tests in the guest.
