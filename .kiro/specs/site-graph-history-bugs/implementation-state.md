...
- Status: stacked PR open; ACK-authorized fixes validated and rerun pending
...
- Focused validator: 18 tests passed.
- Site build: passed.
- Full site tests: 869 passed after merging the reviewed #628 validator hardening.
