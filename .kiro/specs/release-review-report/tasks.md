...
- [ ] 1. Confirm existing report and diff surfaces. Requirements: 1, 2, 3.
...
- [ ] 2. Add command and report model. Requirements: 1, 8, 9.
...
- [ ] 3. Implement source identity and coverage summary. Requirements: 2, 4, 5.
...
- [ ] 4. Compose dependency diff evidence. Requirements: 3, 4, 5.
...
- [ ] 5. Compose contract/API/SQL/package sections. Requirements: 3, 4, 8.
...
- [ ] 6. Add optional path and reverse context. Requirements: 3, 6.
...
- [ ] 7. Implement reviewer checklist. Requirements: 4, 5, 8, 9.
...
- [ ] 8. Add safety and determinism tests. Requirements: 7, 8, 10.
...
- [ ] 9. Add rules and docs. Requirements: 9, 10.
...
- [ ] PR 1: Command shell, report model, source identity/coverage summary, unavailable section statuses.
- [ ] PR 1 must include release-review rule catalog entries before any release-review row or gap is emitted.
- [ ] PR 2: Compose combined dependency diff, combined change impact conversion where available, and top changed surfaces.
- [ ] PR 3: Add contract delta/API/DTO/SQL/package section composition as workflows land; keep package-upgrade delta deferred until specified.
