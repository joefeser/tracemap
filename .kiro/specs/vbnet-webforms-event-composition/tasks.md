...
- [x] 1. Add compiler-backed and bounded fallback VB event evidence.
- [x] 2. Compose VB code-behind/designer and markup evidence into shared Web Forms facts.
- [x] 3. Emit explicit deterministic gaps for ambiguous, late-bound, partial, and unsupported shapes.
