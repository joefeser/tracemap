...
- private/raw disclosure checks are separate from overclaim assertion matching;
  they reject route-scoped private values, raw artifact content, credential-like
  text, local path material, and raw identifier disclosures wherever they appear
  outside approved boundary, limitation, or forbidden-material example copy;
