...
- [x] Establish the exact immutable-snapshot remainder cluster and parser cause.
- [x] Decode only `\015` and `\012` inside quoted design scalars.
- [x] Add parser, projector, privacy, and limitation regression tests.
