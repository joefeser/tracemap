...
- [ ] 1. Confirm current architecture and reusable seams. Requirements: 1, 3, 4, 7, 8.
  - [ ] Inspect current `report`, `diff`, `impact`, `paths`, `reverse`, and `release-review` implementations.
...
- [ ] 2. Add portfolio command shell and option validation. Requirements: 1, 2, 10, 11.
  ...
  - [ ] Parse `--format`, selectors, optional context flags, caps, and `--release-review`.
...
- [ ] 5. Implement index detection and source expansion. Requirements: 1, 3.
  ...
  - [ ] Emit identity gaps for unknown SHA, mismatches, duplicate labels, and ambiguous identity.
...
- [ ] 10. Implement cross-source endpoint alignment. Requirements: 5, 8, 11, 12.
  - [ ] Reuse or extract combined report endpoint matcher.
...
- [ ] 12. Add selectors and caps. Requirements: 6, 7, 8, 9, 10.
  ...
  - [ ] Record ignored selectors when a section is disabled or unavailable.
...
- [ ] 15. Add optional path, reverse, and release-review context. Requirements: 7, 8, 10.
  ...
  - [ ] Validate `--release-review` file and schema when provided.
  - [ ] Preserve release-review classifications without strengthening them.
...
- [ ] PR 2: Dependency surface and edge inventory with redaction and deterministic output.
- [ ] PR 3: Cross-source endpoint alignment and shared-surface grouping.
- [ ] PR 4: Before/after manifest comparison and optional impact composition.
- [ ] PR 5: Optional path, reverse, release-review context, examples, and smoke workflow.
