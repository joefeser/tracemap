...
- [Public Web Forms smoke baseline](docs/validation/webforms-public-smoke-2026-09-15.md): privacy-safe observed coverage from the refreshed public legacy corpus.
