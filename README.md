...
dotnet run --project src/TraceMap.Cli -- reduce --index .tracemap/index.sqlite --contract-delta samples/contract-delta.example.json --out .tracemap/impact-report.md
```
